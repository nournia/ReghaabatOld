object fImport: TfImport
  ...
  object AdvPanel1: TAdvPanel
    ...
    object Label1: TLabel
      ...
      Caption = #1605#1587#1575#1576#1602#1607' :'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 7485192
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object CB_Match: TComboBox
      ...
      TabOrder = 0
      Text = #1607#1605#1607
      OnChange = CB_MatchChange
      Items.Strings = (
        #1607#1605#1607
        #1603#1578#1575#1576
        #1603#1575#1585#1593#1605#1604#1740
        #1607#1606#1585#1740
        #1587#1740#8204#1583#1740)
    end
    object AdvGlowButton2: TAdvGlowButton
      ...
      Width = 60
      Height = 26
      Hint = #1575#1606#1578#1582#1575#1576' '#1607#1605#1607' '#1605#1587#1575#1576#1602#1607#8204#1607#1575#1740' '#1587#1601#1740#1583' '#1585#1606#1711
      Anchors = [akTop, akRight]
    ...
    object bShow: TAdvGlowButton
      AlignWithMargins = True
      Left = 35
      Top = 3
      Width = 29
      Height = 26
      Hint = #1606#1605#1575#1740#1588#1711#1585' '#1605#1581#1578#1608#1740
      ImageIndex = 33
      Images = fMain.ilButton
      DisabledImages = fMain.ilButtonOff
      NotesFont.Charset = DEFAULT_CHARSET
    ...
    object bAdd: TAdvGlowButton
      AlignWithMargins = True
      Left = 225
      Top = 3
      Width = 180
      Height = 26
      Hint = #1575#1601#1586#1608#1583#1606' '#1607#1605#1607' '#1605#1587#1575#1576#1602#1607#8204#1607#1575#1740' '#1586#1585#1583' '#1585#1606#1711
      Margins.Left = 2
      Margins.Right = 2
      Caption = #1575#1601#1586#1608#1583#1606' '#1605#1587#1575#1576#1602#1607#8204#1607#1575#1740' '#1575#1606#1578#1582#1575#1576#8204#1588#1583#1607
      ImageIndex = 13
      Images = fMain.ilButton
      DisabledImages = fMain.ilButtonOff
      NotesFont.Charset = DEFAULT_CHARSET
    ...
    object bReplaceAll: TAdvGlowButton
      AlignWithMargins = True
      Left = 66
      Top = 3
      Width = 156
      Height = 26
      Hint = #1580#1575#1740#1711#1586#1740#1606#1740' '#1607#1605#1607' '#1605#1587#1575#1576#1602#1607#8204#1607#1575#1740#1740' '#1575#1586' '#1580#1583#1608#1604' '#1705#1607' '#1602#1575#1576#1604' '#1580#1575#1740#1711#1586#1740#1606#1740' '#1607#1587#1578#1606#1583
      Caption = #1580#1575#1610#1711#1586#1610#1606#1740' '#1607#1605#1607' '#1605#1587#1575#1576#1602#1607#8204#1607#1575#1740' '#1570#1576#1740
      Images = fMain.ilButton
      DisabledImages = fMain.ilButtonOff
      NotesFont.Charset = DEFAULT_CHARSET
      NotesFont.Color = clWindowText
  ...
  object pShow: TAdvPanel
    ...
    object AdvGroupBox1: TAdvGroupBox
      ...
      object gbPicture: TAdvGroupBox
        ...
        Margins.Bottom = 1
        BorderStyle = bsNone
        CaptionPosition = cpBottomCenter
        Align = alLeft
      ...
      object AdvGroupBox2: TAdvGroupBox
        ...
        Align = alClient
        Caption = #1605#1578#1606' '#1605#1587#1575#1576#1602#1607
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 7485192
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object gbSame: TAdvGroupBox
        ...
        CaptionPosition = cpBottomCenter
        Align = alRight
        Caption = #1578#1588#1575#1576#1607
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 7485192
        Font.Height = -11
        Font.Name = 'Tahoma'
        ...
        object gSame: TAdvColumnGrid
          ...
          ColumnHeaders.Strings = (
            #1580#1575#1740#1711#1586#1740#1606#1740
          ...
          Columns = <
            item
              ...
              Font.Name = 'B Nazanin'
              Font.Style = [fsBold]
              Header = #1580#1575#1740#1711#1586#1740#1606#1740
  ...
  object gMain: TAdvColumnGrid
    ...
    ColumnHeaders.Strings = (
      ''
      #1576#1585#1670#1587#1576#1607#1575
      #1593#1606#1608#1575#1606
      #1605#1587#1575#1576#1602#1607)
    ColumnSize.Stretch = True
    ...
    Columns = <
      ...
      item
        ...
        Font.Name = 'B Nazanin'
        Font.Style = [fsBold]
        Header = #1576#1585#1670#1587#1576#1607#1575
        HeaderAlignment = taCenter
        HeaderFont.Charset = ARABIC_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
      ...
      item
        ...
        Font.Name = 'B Nazanin'
        Font.Style = [fsBold]
        Header = #1605#1587#1575#1576#1602#1607
        HeaderAlignment = taCenter
        HeaderFont.Charset = ARABIC_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
  ...
  object gOther: TAdvColumnGrid
    ...
    ShowHint = False
    TabOrder = 5
    OnDblClick = gOtherDblClick
    ActiveRowColor = 15790320
    GridLineColor = 15855083
    GridFixedLineColor = 13745060
    OnGetCellColor = gOtherGetCellColor
    OnCheckBoxClick = gOtherCheckBoxClick
    ActiveCellFont.Charset = DEFAULT_CHARSET
    ActiveCellFont.Color = clWindowText
    ActiveCellFont.Height = -11
    ActiveCellFont.Name = 'Tahoma'
